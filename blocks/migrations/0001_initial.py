# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-06-13 08:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('figure', models.ImageField(blank=True, null=True, upload_to='exams/question_image')),
                ('exam_type', models.CharField(choices=[('F', 'Final'), ('M', 'Midterm')], default='', max_length=1, verbose_name='type')),
                ('is_deleted', models.BooleanField(default=False)),
                ('status', models.CharField(choices=[('C', 'complete'), ('S', 'spelling error'), ('A', 'incomplete answers'), ('Q', 'incomplete question')], default='', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Revision',
