...
urlpatterns =[
    ...
    url(r'^(?P<slugs>[/\d\w\-]+)/(?P<pk>\d+)/control/list/(?P<selector>\d+|approved|no_answer|pending|no_issues|nonblocking_issues|blocking_issues|lacking_choices)/$', views.list_questions, name='list_questions_by_selector'),
