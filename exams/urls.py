...
urlpatterns =[
    ...
    url(r'^ajax/general/correct_percentage$', views.count_correct_percentage, name='count_correct_percentage'),
    ...
    url(r'^ajax/examiners/delete_correction$', views.delete_correction, name='delete_correction'),
