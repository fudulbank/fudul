...
urlpatterns =[
    ...
    url(r'^ajax/collectors/remove_revision/(?P<pk>\d+)$', views.remove_revision, name='remove_revision'),
    url(r'^ajax/collectors/approve_revision/(?P<pk>\d+)$', views.approve_revision, name='approve_revision'),
